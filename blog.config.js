...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Cryptosamurai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '加密货币投资实验', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.autolinks.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Crypto, 投资', // 网站关键词 英文逗号隔开
